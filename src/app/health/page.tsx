    ...
    <div style={{ minHeight: '100vh', background: '#060912', color: '#fff', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          borderRadius: 20, padding: '5px 10px', fontSize: 11, color: '#a5b4fc', fontWeight: 600
        }}>June 2026</div>
      </header>
          ...
          <div style={{ position: 'relative', display: 'inline-block', marginBottom: 16 }}>
            <svg width="140" height="140" viewBox="0 0 140 140">
              ...
              <circle cx="70" cy="70" r="60" fill="none"
                ...
                strokeLinecap="round"
                strokeDasharray={`${(72 / 100) * 377} 377`}
                strokeDashoffset="94"
            ...
            <div style={{
              ...
              <div style={{ fontSize: 36, fontWeight: 800, fontFamily: "'Syne', sans-serif", letterSpacing: '-2px' }}>72</div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>out of 100</div>
            </div>
          </div>

          <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 4 }}>Good Standing 👍</div>
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', marginBottom: 16 }}>You are doing better than 68% of users</div>

          <div style={{ display: 'flex', justifyContent: 'center', gap: 20 }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 18, fontWeight: 700, color: '#10b981' }}>+5</div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>This week</div>
            </div>
            <div style={{ width: 1, background: 'rgba(255,255,255,0.1)' }} />
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 18, fontWeight: 700, color: '#6366f1' }}>+12</div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>This month</div>
            </div>
            <div style={{ width: 1, background: 'rgba(255,255,255,0.1)' }} />
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 18, fontWeight: 700, color: '#f59e0b' }}>28</div>
        ...
        {activeTab === 'overview' && (
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
              {[
                { label: 'Rupees Saved', value: '₹4,200', icon: '💰', color: '#10b981' },
                { label: 'Schemes Unlocked', value: '3', icon: '🏛️', color: '#6366f1' },
                { label: 'Scams Avoided', value: '2', icon: '🛡️', color: '#ef4444' },
                { label: 'Streak', value: '14 days', icon: '🔥', color: '#f97316' },
              ].map((item, i) => (
                <div key={i} style={{
                  background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <div style={{
              ...
              {milestones.map((m, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ flex: 1, fontSize: 13, fontWeight: m.done ? 600 : 400, color: m.done ? '#fff' : 'rgba(255,255,255,0.5)' }}>
                    {m.label}
                  </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 13, color: '#10b981', fontWeight: 700 }}>33%</span>
              </div>
